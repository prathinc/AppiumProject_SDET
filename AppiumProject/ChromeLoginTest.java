  ...
  public void addTasksList() throws InterruptedException {
	  driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		// Open the browser with the URL
	      ...
	      wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.xpath("//android.view.View/android.view.View[1]")));
	      
	      driver.findElement(By.xpath("//android.view.View[3]/android.widget.Button")).click();
